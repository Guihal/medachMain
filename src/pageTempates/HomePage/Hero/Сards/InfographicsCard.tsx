...
export async function InfographicsCard() {
  ...
  return (
    <Link href={url} className="grid-card grid-card-2">
      <div className="w-full h-full relative group flex flex-col justify-between card-bg">
        ...
        <div className="z-20 w-full h-full opacity-0 group-hover:opacity-100 absolute bg-radial-gradient-green transition-all duration-500 rounded-lg"></div>
        <h2 className="z-20 ml-2 mt-[10px] flex items-center text-white group-hover:text-[#B3DF98] transition-all duration-500 text-sm font-semibold">
          <div className="w-5 h-5 rounded-full bg-[#B3DF98] mr-3"></div>
          Инфографика
        </h2>
