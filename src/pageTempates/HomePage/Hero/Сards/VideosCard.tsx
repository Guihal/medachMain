  ...
  return (
    <Link href={url} className="grid-card">
      <div className="w-full h-full relative group flex flex-col card-bg flex items-center justify-center">
        ...
        <div className="z-20 w-full h-full opacity-0 group-hover:opacity-100 absolute bg-radial-gradient-video transition-all duration-500 rounded-lg"></div>
        <h2 className="z-20 flex flex-col items-center text-white group-hover:text-[#E44646] transition-all duration-500 text-sm font-semibold">
          <div className="flex-center text-sm font-semibold">
            <div className="w-5 h-5 rounded-full bg-[#E44646] mr-3"></div>
            Видео Материалы
          </div>
          <span className="z-20 mt-3 text-lg">
            <svg
              className="group-hover:fill-[#E44646]"
              width="16"
              height="21"
              viewBox="0 0 16 21"
              fill="#fff"
